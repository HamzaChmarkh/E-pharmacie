package com.example.storemanager.Adapter;
...
import com.example.storemanager.admin.DetailActivity;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Categorie", dataList.get(holder.getAdapterPosition()).getDataCate());
...
class MyViewHolder extends RecyclerView.ViewHolder{
    ...
    ImageView recImage;
    TextView recTitle, recDesc, recLang,recCate;
    CardView recCard;
