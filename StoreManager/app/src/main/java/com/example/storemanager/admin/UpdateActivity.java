...
public class UpdateActivity extends AppCompatActivity {
    ...
    Button updateButton;
    EditText updateDesc, updateTitle, updateLang , updateCate;
    String title, desc, lang , cate ;
    String imageUrl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null){
            ...
            updateCate.setText(bundle.getString("Categorie"));
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                saveData();
                Intent intent = new Intent(UpdateActivity.this, HomeAdminActivity.class);
    ...
    public void updateData(){
        ...
        cate = updateCate.getText().toString().trim();
