...
import com.example.storemanager.ActivityPaymentList;
import com.example.storemanager.Adapter.MyAdapter;
import com.example.storemanager.DataClass;
import com.example.storemanager.LoginActivity;
import com.example.storemanager.R;
import com.example.storemanager.Shopall;
...
public class HomeAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HomeAdminActivity.this , ActivityPaymentList.class));
            }
        });
